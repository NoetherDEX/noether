...
| L0-8 | Multi-source price integrity: 2-of-3 publisher quorum + median (with fail-closed interim) | L | mixed | noeracle-upstream | L0-7, L0-19 | in-progress — Noether consumption CODE DONE 2026-07-21 (router quorum relay bcd1ecf + tx-builders d23be68 + web 0a31536 + keeper 3e3b7bc, all dual-ABI/inert pre-Batch-1); remaining: Noeracle-side fresh deploy, keeper multi-key publish loop, operator quorum>1 + strict-assets arming |
